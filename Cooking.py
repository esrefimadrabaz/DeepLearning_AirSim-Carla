...
DIRS = ['episode_00001.txt', 'episode_00002.txt', 'episode_00003.txt', 'episode_00003.txt', 'episode_00004.txt', 'episode_00005.txt', 'episode_00006.txt',
'episode_00007.txt', 'episode_00008.txt', 'episode_00009.txt', 'episode_00010.txt', 'episode_00011.txt', 'episode_00012.txt', 'episode_00013.txt', 'episode_00014.txt',
 'episode_00015.txt', 'episode_00016.txt', 'episode_00017.txt', 'episode_00018.txt', 'episode_00019.txt', 'episode_00020.txt',  'episode_00021.txt',  'episode_00022.txt']
...
def generateDataMapAirSim(folders):
    ...
    for folder in folders:
        ...
        current_df = pd.read_csv(os.path.join(folder, 'final.txt'), sep='\t')
        ...
        for i in range(1, current_df.shape[0] - 1, 1):
            ...
            image_filepath = os.path.join(os.path.join(folder, 'images'), current_df.iloc[i]['ImagePath']).replace('\\', '/')
